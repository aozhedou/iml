...
if __name__ == "__main__":
    ...
    X_filter_train_, Y_filter_train_ = Uncertainty_filter(X_train, Y_train, model, num_classes, args.preepoch, beta, args, device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print('Train Epoch: {} Loss: {:.6f}'.format(
            epoch, loss))
    X_filter_test, Y_filter_test = Uncertainty_filter(X_test, Y_test, model, num_classes, epoch, beta, args, device)
